function Footer() {
    return (
        <footer>
            <div className="px-4 space-y-10 lg:hidden">
                <div className="flex flex-col">
                    <button className="flex justify-between">
                        <h1 className="font-medium">About Us</h1>
                        <span className="rounded-full hover:bg-secondary-dark h-11 w-11 pt-1.5 pl-1.5"><svg viewBox="0 0 24 24"
                            className="valign-middle absoluteCenter" preserveAspectRatio="xMidYMid meet" aria-hidden="true"
                            focusable="false">
                ...
                <div className="flex flex-col">
                    <button className="flex justify-between">
                        <h1 className="font-medium">Social Impact</h1>
                        <span className="rounded-full hover:bg-secondary-dark h-11 w-11 pt-1.5 pl-1.5"><svg viewBox="0 0 24 24"
                            className="valign-middle absoluteCenter" preserveAspectRatio="xMidYMid meet" aria-hidden="true"
                            focusable="false">
                            {/* style="width: 32px; height: 32px; overflow: visible; fill: currentcolor;" */}
                ...
                <div className="flex flex-col">
                    <button className="flex justify-between">
                        <h1 className="font-medium">For Business Partners</h1>
                        <span className="rounded-full hover:bg-secondary-dark h-11 w-11 pt-1.5 pl-1.5"><svg viewBox="0 0 24 24"
                            className="valign-middle absoluteCenter" preserveAspectRatio="xMidYMid meet" aria-hidden="true"
                            focusable="false">
                            {/* style="width: 32px; height: 32px; overflow: visible; fill: currentcolor;" */}
                ...
                <div className="flex flex-col">
                    <button className="flex justify-between">
                        <h1 className="font-medium">Order and Pickup</h1>
                        <span className="rounded-full hover:bg-secondary-dark h-11 w-11 pt-1.5 pl-1.5"><svg viewBox="0 0 24 24"
                            className="valign-middle absoluteCenter" preserveAspectRatio="xMidYMid meet" aria-hidden="true"
                            focusable="false">
                            {/* style="width: 32px; height: 32px; overflow: visible; fill: currentcolor;" */}
            ...
            <div className="hidden lg:flex justify-between space-x-4 mx-10">
                <div className="flex flex-col font-medium text-gray-400 space-y-6">
                    <h1 className="text-2xl font-medium text-black">About Us</h1>
                    <a href="#" className="hover:text-black">Our Heritage</a>
                    <a href="#" className="hover:text-black">Our Coffee</a>
                    <a href="#" className="hover:text-black">Stories and News</a>
                    <a href="#" className="hover:text-black">Investor Relations</a>
                    <a href="#" className="hover:text-black">Policies and Standards</a>
                    <a href="#" className="hover:text-black">Customer Service</a>
                </div>
                <div className="flex flex-col font-medium text-gray-400 space-y-6">
                    <h1 className="text-2xl font-medium text-black">Careers</h1>
                    <a href="#" className="hover:text-black">Culture and Values</a>
                    <a href="#" className="hover:text-black">Inclusion, Diversity, and Equity</a>
                    <a href="#" className="hover:text-black">College Achievement Plan</a>
                    <a href="#" className="hover:text-black">U.S. Careers</a>
                    <a href="#" className="hover:text-black">International Careers</a>
                </div>
                <div className="flex flex-col font-medium text-gray-400  space-y-6">
                    <h1 className="text-2xl font-medium text-black">Social Impact</h1>
                    <a href="#" className="hover:text-black">Ethical Sourcing</a>
                    <a href="#" className="hover:text-black">Leading in Sustainability</a>
                    <a href="#" className="hover:text-black">Strengthening Communities</a>
                    <a href="#" className="hover:text-black">Creating Oppurtinities</a>
                    <a href="#" className="hover:text-black">Global Social Impact Report</a>
                </div>
                <div className="flex flex-col font-medium text-gray-400 space-y-6">
                    <h1 className="text-2xl font-medium text-black">For Business Partners</h1>
                    <a href="#" className="hover:text-black">Landlord Support Center</a>
                    <a href="#" className="hover:text-black">Suppliers</a>
                    <a href="#" className="hover:text-black">Corporate Gift Card Sales</a>
                    <a href="#" className="hover:text-black">Office and Foodservice Coffee</a>
                </div>
                <div className="flex flex-col font-medium text-gray-400 space-y-6">
                    <h1 className="text-2xl font-medium text-black">Order and Pickup</h1>
                    <a href="#" className="hover:text-black">Order on the App</a>
                    <a href="#" className="hover:text-black">Order on the Web</a>
                    <a href="#" className="hover:text-black">Delivery</a>
                    <a href="#" className="hover:text-black">Order and Pickup Options</a>
                    <a href="#" className="hover:text-black">Explore and Find Coffee for Home</a>
                </div>
            </div>

            <hr className="my-10 mx-4" />

            <div className="flex flex-col px-4 space-y-5 mb-11">
                <div className="flex space-x-4">
                    <a href="#">
                        <svg viewBox="0 0 24 24" className="valign-middle absoluteCenter" preserveAspectRatio="xMidYMid meet"
                ...
                <div className="flex flex-col lg:flex-row space-y-3.5 lg:space-y-0">
                    <a href="#" className="hover:underline">Privacy Policy</a><span className="hidden px-2 lg:inline-block">|</span>
                    <a href="#" className="hover:underline">Terms of Use</a><span className="hidden px-2 lg:inline-block">|</span>
                    <a href="#" className="hover:underline">CA Supply Chain Act</a><span
                        className="hidden px-2 lg:inline-block">|</span>
                    <a href="#" className="hover:underline">Submit Your Idea</a><span
                        className="hidden px-2 lg:inline-block">|</span>
                    <a href="#" className="hover:underline">Cookie Preferences</a><span
                        className="hidden px-2 lg:inline-block">|</span>
                </div>
                <span className="text-sm text-gray-600">© 2021 Starbucks Coffee Company. All rights reserved.</span>
            </div>
        </footer>
    );
}
